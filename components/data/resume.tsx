  ...
  projects: [
    {
      ...
      active: false,
      description:
        "Security application designed for managing entry and exit at an estate vil lage gate using QR code with own system to generate and tracking log",
      technologies: [
        "Node.js",
        "Javascript",
        "PostgreSQL",
